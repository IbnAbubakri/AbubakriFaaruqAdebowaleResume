        ...
        <div className="space-y-3">
          {project.liveDemo && (
            <a
              ...
              className="flex items-center gap-2 text-sm font-medium py-2 -my-2 transition-colors"
          ...
          {project.github && (
            <a
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground py-2 -my-2 transition-colors"
            >
