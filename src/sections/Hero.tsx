        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 text-center md:text-left">
            <motion.p
              ...
              className="text-sm font-medium text-blue-600 dark:text-blue-400 uppercase tracking-widest mb-4"
            >
              IT Professional
            </motion.p>
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-7xl font-bold text-gray-900 dark:text-white leading-tight"
            >
              Abubakri{' '}
            ...
            <motion.p
              ...
              className="mt-6 text-lg text-gray-600 dark:text-gray-400 max-w-2xl leading-relaxed"
            >
            ...
            >
              ...
              <a
                ...
                download
                className="px-6 py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:border-blue-600 hover:text-blue-600 dark:hover:border-blue-400 dark:hover:text-blue-400 transition-colors cursor-pointer"
              >
                Download CV
              </a>
              <a
                href="/#projects"
                className="px-6 py-3 text-gray-500 dark:text-gray-500 font-medium hover:text-gray-900 dark:hover:text-gray-300 transition-colors cursor-pointer"
              >
                View Projects &rarr;
              </a>
            </motion.div>
